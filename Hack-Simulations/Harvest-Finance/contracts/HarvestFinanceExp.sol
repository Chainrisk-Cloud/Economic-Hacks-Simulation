...
contract ContractTest {
    ...
    function callAnotherContract(address _to)public payable{
        (bool suc,) = payable(_to).call{value:msg.value}(abi.encodeWithSignature("depositFunds()"));
        require(suc,"suc failed");
    }
